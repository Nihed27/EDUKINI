...
export class MesEcolesComponent {
  ...
  ecoles: Ecole[] = [
    ...
    },
    {
      ...
      site: "enis.nachd-it.tn",
      siteUrl: "https://enis.nachd-it.tn/",
    ...
    },
    {
      ...
      site: "universite.tn/…/enim",
      siteUrl: "https://www.universite.tn/Universite-de-Monastir/ecole-nationale-d-ingenieurs-de-monastir.html",
      campus: "Monastir",
      lat: 35.7643,
      lng: 10.8113,
      langues: ["Arabe", "Français", "Anglais"],
